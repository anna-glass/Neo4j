...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>YC Network Explorer</title>
        <link rel="shortcut icon" href="/images/favicon.ico" />
        <meta
          name="description"
          content="YC Network Explorer - Visualize connections between YC founders, partners, and companies"
        />
        <meta property="og:title" content="YC Network Explorer" />
        <meta
        ...
        <meta name="twitter:title" content="YC Network Explorer" />
        <meta
